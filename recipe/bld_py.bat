...
set MUJOCO_CMAKE_ARGS="-DMUJOCO_PYTHON_USE_SYSTEM_PYBIND11:BOOL=ON -DMUJOCO_SIMULATE_USE_SYSTEM_MUJOCO:BOOL=ON -DMUJOCO_SIMULATE_USE_SYSTEM_GLFW:BOOL=ON %CMAKE_ARGS% -DCMAKE_PROJECT_TOP_LEVEL_INCLUDES=%RECIPE_DIR%\fetchcontent_to_find_package_provider.cmake"
